 ...
 *
 * This bundle registers every Blueprint element at import. An application that ships its own copy
 * of Blueprint rather than importing this one registers the same tag names, and whichever copy
